...
@interface DamCalendarView()

{
    CGFloat itemW;
    CGFloat itemH;
}
@property(nonatomic,strong) DamCalendarItem *calendarItem;
@property(nonatomic,strong) UIScrollView *scrollView;
@property(strong,nonatomic) DamCalendarItem *leftCalendarItem;
@property(strong,nonatomic) DamCalendarItem *centerCalendarItem;
@property(strong,nonatomic) DamCalendarItem *rightCalendarItem;
...
@implementation DamCalendarView
...
-(void)createCalendarItems
{
    ...
    self.leftCalendarItem = [[DamCalendarItem alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, itemH*6)];
    [self.scrollView addSubview:self.leftCalendarItem];
    
    self.centerCalendarItem = [[DamCalendarItem alloc] initWithFrame:CGRectMake(self.frame.size.width, 0, self.frame.size.width, itemH*6)];
    self.centerCalendarItem.meetingData = _meetingData;
    ...
    self.rightCalendarItem = [[DamCalendarItem alloc] initWithFrame:CGRectMake(2*self.frame.size.width, 0, self.frame.size.width, itemH*6)];
...
//{
//
//    self.scrollView.frame = CGRectMake(0, 0, self.frame.size.width, 40*7);
//    self.scrollView.contentSize = CGSizeMake(3 * self.frame.size.width, 40*7);
//    self.scrollView.contentOffset = CGPointMake(self.frame.size.width, 0);
//    
//    
//    self.leftCalendarItem.frame=CGRectMake(0, 0, self.frame.size.width, 40*7);
//    
//    CGRect itemFrame = self.leftCalendarItem.frame;
//    itemFrame.origin.x = self.frame.size.width;
//    self.centerCalendarItem.frame =CGRectMake(0, 0, self.frame.size.width, 40*7);
//    self.centerCalendarItem.frame = itemFrame;
//    
//    itemFrame.origin.x = self.frame.size.width * 2;
//    self.rightCalendarItem.frame=CGRectMake(0, 0, self.frame.size.width, 40*7);
