...
@interface SendViewController : UIViewController<UIAlertViewDelegate,UITableViewDataSource,UITableViewDelegate,TouchTableViewDelegate,UISearchBarDelegate>
