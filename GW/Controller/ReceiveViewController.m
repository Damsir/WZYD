...
@interface ReceiveViewController ()<UITableViewDelegate,UITableViewDataSource,SendViewDelegate>
...
-(void)loadData
{
    ...
    NSDictionary *paremeters = @{@"type":@"sw",@"index":@"0",@"size":[NSString stringWithFormat:@"%ld",(long)_pageSize],@"user":[Global userName],@"me":@"1",@"uid":[Global userId],@"deviceNumber":[Global deviceUUID],@"username":[Global userName]};
