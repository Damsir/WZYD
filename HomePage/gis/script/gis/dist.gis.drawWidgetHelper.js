(function() {
    dist.gis.drawWidgetHelper = function(params) {
       ...
       // this.drawLayerID = "DIST_DRAW_LAYER_" + dist.desktop.nextSequence();
        this.drawLayerID = "DIST_DRAW_LAYER";
        ...
        this.createColorPicker = function() {
            ...
            $(canvasPicker).bind('touchstart click', function(e) {
                if (bCanPreview) {
                    ...
                    if (e.touches != 'TouchList') {
                        ...
                        if (e.touches.length > 0) {
                            ...
                            startX = touch.pageX;
                            startY = touch.pageY;
                            canvasX = Math.floor(startX - canvasOffset.left);
                            canvasY = Math.floor(startY - canvasOffset.top);
                        }
                    }
                    ...
                    var pixel = imageData.data; // alert(pixel);
