...
document.write('<script type="text/javascript" src="script/gis/dist.gis.distMapHelper.js"></script> ');

///<summary>设备几何定位辅助帮手</summary>
///<param name="map" type="Map">需要辅助设备几何定位的Map</param>
///<returns>没有返回值</returns>
function DistGeolocationHelper(map) {

    var targetMap = map;
    var watchPositionHandler;
    var localGraphic;
    var mapHelper = new DistMapHelper(map);
    var gpsLayer;
