...
@implementation UITableView (ReloadExten)
/**
 *  UITableView重新加载动画
 *
...
- (void) visibleRowsBeginDirectionType:(SHReloadAnimationDirectionType)direction animation:(NSTimeInterval)animationTime interval:(NSTimeInterval)interval
{
    ...
    switch (direction) {
        case SHReloadAnimationDirectionTop:
        {
            ...
            break;
        case SHReloadAnimationDirectionBottom:
        {
            for (int i = 0; i < count; i++) {
            ...
            break;
        case SHReloadAnimationDirectionLeft:
        {
            for (int i = 0; i < count; i++) {
                NSIndexPath *path = visibleArray[i];
                UITableViewCell *cell = [self cellForRowAtIndexPath:path];
            ...
            break;
        case SHReloadAnimationDirectionRight:
        {
            for (int i = 0; i < count; i++) {
                NSIndexPath *path = visibleArray[i];
                UITableViewCell *cell = [self cellForRowAtIndexPath:path];
