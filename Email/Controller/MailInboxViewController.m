...
@interface MailInboxViewController ()<UITableViewDelegate,UITableViewDataSource>
...
-(void)loadData
{
    ...
    NSDictionary *paremeters = @{@"type":@"inbox",@"index":@"0",@"size":[NSString stringWithFormat:@"%ld",(long)_pageSize],@"user":[Global userName],@"me":@"1",@"uid":[Global userId],@"deviceNumber":[Global deviceUUID],@"username":[Global userName]};
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    mailDetailVC.mailType = @"mailInbox";
