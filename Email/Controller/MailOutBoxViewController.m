...
@interface MailOutBoxViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MailOutBoxViewController
...
-(void)loadData
{
    ...
    NSDictionary *paremeters = @{@"type":@"outbox",@"index":@"0",@"size":[NSString stringWithFormat:@"%ld",(long)_pageSize],@"user":[Global userName],@"me":@"1",@"uid":[Global userId],@"deviceNumber":[Global deviceUUID],@"username":[Global userName]};
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    mailDetailVC.mailType = @"mailOutbox";
